...
from Dutility import draw_grid
from Dpriority_queue import PriorityQueue
from Dgrid import AgentViewGrid, SquareGrid
from Dutility import grid_from_string
...
class DStarLite(object):
    ...
    def move_to_goal(self):
        ...
        while self.position != self.goal:
            ...
            print("U: ",self.frontier.elements)
            if new_walls:
                path = []
                ...
                print("---new U: ",self.frontier.elements)
                self.compute_shortest_path()
            yield self.position, observation, self.graph.walls
